...
//     document.body.innerHTML ="<h1 id='rahini' >you are eligible to drive </h1>";
//     document.getElementById("rahini").style.color="green";
//     //document.body.innerText ="<h1>you are eligible to drive </h1>";
//     //document.body.textContent ="<h1>you are eligible to drive </h1>";
...
// // document.body.innerHTML = `<div><h1>${PRODUCTS[0].title}</h1><img src="${PRODUCTS[0].thumbnail}" </div>`;


// // document.body.innerHTML = `<h1>${PRODUCTS[0].title}</h1> <img src="${PRODUCTS[0].thumbnail}" alt="${PRODUCTS[0].title}"> <p>${PRODUCTS[0].description}</p> <p>Price: $${PRODUCTS[0].price}</p> <p>Rating: ${PRODUCTS[0].rating} / 5</p>`;
...
// h1.textContent="chitkara university";
// h1.setAttribute("id","rahini");

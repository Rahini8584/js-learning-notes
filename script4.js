...
// var a= age >=18 ? console.log("eligible to vote") : console.log("chotey ho abhi aap!");
// var a= age >=18 ? "eligible to vote" : "chotey ho abhi aap!";
// console.log(a);


// switch statement---- does not using batching as used in if else 
    // break is necessary 
// var a= 8;
// switch(a){
//     case 1:
...
// const aar = ["rahini","kalra","red","blue"];
// console.log(aar);
// function example(elm,index,arr){
//     // console.log("hello");
//     // 
//     // console.log(elm);
//     // console.log(index);
